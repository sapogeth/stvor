  ...
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px', fontFamily: 'system-ui', background: '#ffffff', color: '#000' }}>
      <header style={{ textAlign: 'center', marginBottom: '40px', borderBottom: '2px solid #007bff', paddingBottom: '20px' }}>
        <h1 style={{ fontSize: '2.5em', margin: '10px 0', color: '#000' }}>🔐 Security Center</h1>
      ...
      <nav style={{ display: 'flex', gap: '10px', marginBottom: '30px', borderBottom: '2px solid #ddd', flexWrap: 'wrap' }}>
        {['overview', 'e2e', 'defense', 'test', 'docs'].map((tab) => (
          <button
            ...
            style={{
              padding: '12px 24px',
              border: 'none',
              background: activeTab === tab ? '#007bff' : '#e8e8e8',
      ...
      <main>
        ...
        {activeTab === 'overview' && (
          <section>
            <h2 style={{ color: '#000', marginBottom: '20px' }}>Complete Security Architecture</h2>
            <p style={{ fontSize: '1.05em', lineHeight: '1.6', color: '#222', marginBottom: '30px' }}>
        ...
        {activeTab === 'e2e' && (
          <section>
            <h2 style={{ color: '#000', marginBottom: '20px' }}>🔒 End-to-End Encryption (Layer 1)</h2>

            <h3 style={{ marginTop: '30px', color: '#000' }}>Double Ratchet Protocol</h3>
            ...
            <h3 style={{ marginTop: '30px', color: '#000' }}>Post-Quantum Hybrid Cryptography</h3>
            <p style={{ color: '#222' }}>Prepared for quantum computers while maintaining backward compatibility:</p>
            ...
            <h3 style={{ marginTop: '30px', color: '#000' }}>Message Encryption</h3>
            ...
            <h3 style={{ marginTop: '30px', color: '#000' }}>Key Derivation</h3>
            <ul style={{ paddingLeft: '20px', color: '#222' }}>
            ...
            <h3 style={{ marginTop: '30px', color: '#000' }}>Session Management</h3>
            <ul style={{ paddingLeft: '20px', color: '#222' }}>
        ...
        {activeTab === 'defense' && (
          <section>
            <h2 style={{ color: '#000', marginBottom: '20px' }}>🛡️ Defense-in-Depth Security (Layer 2)</h2>
            <p style={{ fontSize: '1.05em', lineHeight: '1.6', color: '#222', marginBottom: '30px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '20px', marginBottom: '40px' }}>
              ...
              <div style={{ border: '2px solid #007bff', borderRadius: '8px', padding: '20px', background: '#f0f7ff' }}>
                ...
                <h4 style={{ color: '#000' }}>RelayPinner - Network Integrity Verification</h4>
                <p style={{ color: '#d9534f', fontWeight: 'bold' }}>Problem:</p>
                <p style={{ color: '#222' }}>Autonomous Systems (ASes) can perform network-level attacks to hijack relay server connections without routing manipulation.</p>
                <p style={{ color: '#5cb85c', fontWeight: 'bold', marginTop: '10px' }}>Solution:</p>
                <p style={{ color: '#222' }}>Ed25519-signed relay identity verification using challenge-response protocol.</p>
              ...
              <div style={{ border: '2px solid #5cb85c', borderRadius: '8px', padding: '20px', background: '#f0fff4' }}>
                ...
                <h4 style={{ color: '#000' }}>Message Padding - Traffic Analysis Resistance</h4>
                <p style={{ color: '#d9534f', fontWeight: 'bold' }}>Problem:</p>
                <p style={{ color: '#222' }}>Message size distribution reveals content information even when encrypted.</p>
                <p style={{ color: '#5cb85c', fontWeight: 'bold', marginTop: '10px' }}>Solution:</p>
                <p style={{ color: '#222' }}>Adaptive message padding to fixed block sizes (256, 512, or 1024 bytes).</p>
                <div style={{ background: '#fff', padding: '10px', borderRadius: '4px', marginBottom: '10px', fontSize: '0.9em' }}>
                  <ul style={{ margin: '0', paddingLeft: '20px', color: '#222' }}>
              ...
              <div style={{ border: '2px solid #f0ad4e', borderRadius: '8px', padding: '20px', background: '#fffbf0' }}>
                ...
                <h4 style={{ color: '#000' }}>PrivacyConfigManager - Side-Channel Privacy</h4>
                <p style={{ color: '#d9534f', fontWeight: 'bold' }}>Problem:</p>
                <p style={{ color: '#222' }}>Automatic presence indicators (typing, read receipts, online status) leak user behavior patterns.</p>
                <p style={{ color: '#5cb85c', fontWeight: 'bold', marginTop: '10px' }}>Solution:</p>
                <p style={{ color: '#222' }}>Opt-in features disabled by default with timing obfuscation and event batching.</p>
                <div style={{ background: '#fff', padding: '10px', borderRadius: '4px', marginBottom: '10px', fontSize: '0.9em' }}>
                  <ul style={{ margin: '0', paddingLeft: '20px', color: '#222' }}>
            ...
            <div style={{ background: '#f0f0f0', padding: '20px', borderRadius: '8px' }}>
              <h3 style={{ color: '#000', marginBottom: '15px' }}>Implementation Statistics</h3>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '15px', marginTop: '15px' }}>
                {[
                  ...
                  <div key={stat.label} style={{ textAlign: 'center', padding: '15px', background: 'white', borderRadius: '4px' }}>
                    <div style={{ fontSize: '0.9em', color: '#666', marginBottom: '5px', fontWeight: 'bold' }}>{stat.label}</div>
        ...
        {activeTab === 'docs' && (
          <section>
            <h2 style={{ color: '#000', marginBottom: '20px' }}>📚 Documentation & Resources</h2>

            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '20px' }}>
              <div style={{ border: '1px solid #ddd', borderRadius: '8px', padding: '20px', background: '#f9f9f9' }}>
                <h3 style={{ color: '#000' }}>📖 Quick Start</h3>
                <p style={{ color: '#222' }}>New to our security architecture? Start by exploring the "Overview" and "E2E" tabs above.</p>
              </div>

              <div style={{ border: '1px solid #ddd', borderRadius: '8px', padding: '20px', background: '#f9f9f9' }}>
                <h3 style={{ color: '#000' }}>🔍 Complete API</h3>
                <p style={{ color: '#222' }}>Full API documentation for all security mechanisms:</p>
                <code style={{ background: '#fff', padding: '8px', display: 'block', borderRadius: '4px', overflow: 'auto', fontSize: '0.85em', marginTop: '8px', color: '#000' }}>
                  import {'{'}RelayPinner, padMessage{'}'} from '@ilyazh/crypto';
                </code>
              </div>

              <div style={{ border: '1px solid #ddd', borderRadius: '8px', padding: '20px', background: '#f9f9f9' }}>
                <h3 style={{ color: '#000' }}>📖 Integration Guide</h3>
                <p style={{ color: '#222' }}>Step-by-step integration guide for developers:</p>
                <ul style={{ paddingLeft: '20px', fontSize: '0.9em', marginTop: '8px', color: '#222' }}>
              ...
              <div style={{ border: '1px solid #ddd', borderRadius: '8px', padding: '20px', background: '#f9f9f9' }}>
                <h3 style={{ color: '#000' }}>📊 Research Papers</h3>
                <ul style={{ paddingLeft: '20px', fontSize: '0.9em', color: '#222' }}>
              ...
              <div style={{ border: '1px solid #ddd', borderRadius: '8px', padding: '20px', background: '#f9f9f9' }}>
                <h3 style={{ color: '#000' }}>⚙️ Configuration</h3>
                <code style={{ background: '#fff', padding: '12px', display: 'block', borderRadius: '4px', fontSize: '0.8em', overflow: 'auto', color: '#000' }}>
              ...
              <div style={{ border: '1px solid #ddd', borderRadius: '8px', padding: '20px', background: '#f9f9f9' }}>
                <h3 style={{ color: '#000' }}>📁 Source Code</h3>
                <ul style={{ paddingLeft: '20px', fontSize: '0.9em', color: '#222' }}>
      ...
      <footer style={{ marginTop: '60px', paddingTop: '20px', borderTop: '2px solid #007bff', textAlign: 'center', color: '#555' }}>
        <p style={{ color: '#555' }}>
          🔐 Security Center - Complete Security Architecture
          <br />
          <strong style={{ color: '#000' }}>Layer 1:</strong> <span style={{ color: '#555' }}>End-to-End Encryption (Industry Standard)</span>
          | <strong style={{ color: '#000' }}>Layer 2:</strong> <span style={{ color: '#555' }}>Defense-in-Depth (KAIST Research)</span>
          <br />
          <small style={{ color: '#999' }}>Version 1.0.0 | 2025-11-20</small>
        </p>
      </footer>
    </div>
  );
